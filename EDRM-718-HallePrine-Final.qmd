...
model1_table %>%
  kbl(
    caption = "Linear Regression Predicting Optimism from GPA, Gender, and Age",
    digits = 3,
    booktabs = TRUE
  ) %>%
  kable_styling(full_width = FALSE, position = "center") %>%
...
model2_table %>%
  kbl(
    caption = "Linear Regression Predicting Optimism from GPA, Discipline, Gender, and Age (with Interaction)",
    digits = 3,
    booktabs = TRUE
  ) %>%
  kable_styling(full_width = FALSE, position = "center") %>%
...
tukey_table %>%
  kbl(
    caption = "Tukey HSD Post-Hoc Comparisons of Optimism by Discipline", 
    digits = 3,
    booktabs = TRUE
  ) %>%
  kable_styling(full_width = FALSE, position = "center") %>%
